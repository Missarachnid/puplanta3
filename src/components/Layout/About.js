...
const About = () => { 
  return (
    <div>
        <div id='about'>
          <div>
            <h1 className='headline copy'>What is this site for?</h1>
            <p>
            ...
            <div className='row'>
              ...
              <div className='col-md-4'>
                <div className='card dog-card'>
                <p className='card-title copy'>Nimbus</p>
