...
const Privacy = () => (
  <div className='jumbotron' id='privacy'>
    <h1 className='headline'>Privacy Policy</h1>
      <p>Melissa Kepler built the Puplanta app as a free app. This SERVICE is provided by Melissa Kepler at no cost and is intended
          for use as is.</p>
      ...
      <p>For a better experience while using our Service, I may require you to provide us with certain
          personally identifiable information, including but not limited to username and email. 
      ...
      <p>The app does use third party services that may collect information used to identify you. 
        <a href='https://firebase.google.com/support/privacy' rel='noopener noreferrer' target="_blank"> Google Firebase's Privacy and Security.</a></p>

      <h3><strong>Log Data</strong></h3>
      <p>I want to inform you that whenever you use [my|our] Service, in case of an error in the app I may collect
      ...
      <p>If you have any questions or suggestions about [my|our] Privacy Policy, do not hesitate to contact
          me at admin@puplanta.awsapps.com</p>
      <p>This Privacy Policy page was created at <a href="https://privacypolicytemplate.net" rel='noopener noreferrer' target="_blank">privacypolicytemplate.net</a>.</p>
    </div>
);
